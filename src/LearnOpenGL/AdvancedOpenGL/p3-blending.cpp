...
const char* VShaderSrc = "../../../shader/AdvancedOpenGL/p3/shader.vs";
const char* FShaderSrc = "../../../shader/AdvancedOpenGL/p3/shader.fs";
const char* cubeTextureSrc = "../../../img/metal.png";
const char* planeTextureSrc = "../../../img/marble.jpg";
const char* grassTextureSrc = "../../../img/grass.png";
...
int main() {
    ...
    GLuint grassTexture = loadTexture(grassTextureSrc);
