...
int main() {
    ...
    // -------------------------
    Shader shader("../../../shader/AdvancedOpenGL/p5/framebuffer.vs",
                  "../../../shader/AdvancedOpenGL/p5/framebuffer.fs");
    Shader screenShader("../../../shader/AdvancedOpenGL/p5/framebuffer_screen.vs",
                        "../../../shader/AdvancedOpenGL/p5/framebuffer_screen.fs");
    ...
    // load textures
    // -------------
    unsigned int cubeTexture = loadTexture("../../../img/container.jpg");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // set clear color to white (not really necessary actually, since we
